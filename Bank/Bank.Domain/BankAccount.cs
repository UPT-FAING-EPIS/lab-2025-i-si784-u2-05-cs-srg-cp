...
{
    /// <summary>Mensaje para cuando el monto a debitar excede el saldo.</summary>
    public const string DebitAmountExceedsBalanceMessage = "Debit amount exceeds balance";

    /// <summary>Mensaje para cuando el monto a debitar es menor a cero.</summary>
    public const string DebitAmountLessThanZeroMessage = "Debit amount is less than zero";

    /// <summary>Mensaje para cuando el monto del credito es menor a cero.</summary>
    public const string CreditAmountLessThanOrEqualToZeroMessage = "Credit amount must be positive";

    private readonly string m_customerName;
    private double m_balance;

    /// <summary>Constructor para pruebas internas.</summary>
    private BankAccount() { }

    /// <summary>Inicializa una nueva instancia de <see cref="BankAccount"/>.</summary>
    ...
    /// <summary>Obtiene el saldo actual.</summary>
    public double Balance => m_balance;

    /// <summary>Debita una cantidad de la cuenta.</summary>
    ...
    /// <summary>Acredita una cantidad a la cuenta.</summary>
